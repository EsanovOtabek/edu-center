                    ...
                    <div class="card-body row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="fio" id="fio" class="form-control" required
                                value="{{ $teacher->fio }}" placeholder="F.I.Sh">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="passport_number" id="passport_number" class="form-control" required
                                value="{{ $teacher->passport_number }}" placeholder="AAXXXXXXX">
                        </div>

                        <div class="form-group col-sm-6">
                            <label for="phone">Telefon raqami</label>
                            <input type="text" name="phone" id="phone" class="form-control" required
                                value="{{ $teacher->phone }}" placeholder="+998XXYYYYYYY">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="salary_percentage">Oylik foiz</label>
                            <input type="number" name="salary_percentage" id="salary_percentage" class="form-control"
                                required min="0" max="100" value="{{ $teacher->salary_percentage }}"
                                placeholder="0">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="password">Parolni o'zgartirish <span class="badge badge-danger">(Agar o'zgartirishni
                                    xohlamasangiz bo'sh qoldiring)</span></label>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="subjects[]" class="select2" multiple="multiple"
                                data-placeholder="Fanlarni tanlash" style="width: 100%;" required>
                        ...
                        @if ($teacher->image)
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <img id="imagePreview" src="{{ asset('storage/' . $teacher->image) }}"
                                        alt="O'qituvchi rasmi" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            </div>
                        @else
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <img id="imagePreview" src="#" alt="Tanlangan rasm" class="img-thumbnail"
